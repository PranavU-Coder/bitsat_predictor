  ...
  const sections = [
    {
      ...
      content: (
        <p>
          ...
          the same branch which can be observed from the plots. Simple averages
          and extrapolations fail because there's a hidden external variable:{" "}
          <strong className="text-[var(--brutal-accent)]">
            paper difficulty
          </strong>
          . This variable has a massive impact on cutoffs. Our project was born
          to mathematically model this parameter.
        </p>
      ),
    },
    {
      ...
      content: (
        <>
          <p>
            ...
            manually sourced from bits admission site and collegepravesh.com,
          ...
          <p className="mt-3">
            ...
            (
            <code className="text-[var(--brutal-accent)] text-xs">
              score × 390/450
            </code>
            ) to normalize against the current 390-mark format. The final
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            Instead of a single uncertain number, we provide three scenarios via{" "}
            <strong className="text-[var(--brutal-text)]">
              Difficulty-adjusted forecasting
            </strong>
            :
          </p>
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="p-3 rounded-[10px] bg-[var(--brutal-bg)] border border-[var(--brutal-border)] text-center">
              ...
              <div className="font-display font-bold text-red-400">d = 0.8</div>
              <div className="text-xs text-[var(--brutal-text-muted)] mt-1">
                Easy paper year
              </div>
            </div>
    ...
    },
    {
      ...
      content: (
        <p>
          Branches like MnC, Nanoscience, and Electronics & Computer Engineering
          have{" "}
          <strong className="text-[var(--brutal-text)]">
            0–2 years of data
          </strong>{" "}
          — nowhere near enough for reliable predictions. Augmenting data proved
          futile since each branch follows unique trends. As these branches
          accumulate more data, they will be incorporated.{" "}
          <strong className="text-[var(--brutal-accent)]">
            Transparency over completeness any day
          </strong>
          .
        </p>
      ),
      ...
      content: (
        <>
          ...
          <p className="mt-3">
            ...
            , not an exact predictor. No model can predict exact cutoffs and we
            intend to provide honest, data-grounded ranges.
          </p>
        </>
      ),
    },
      ...
      <div className="brutal-container pt-12 md:pt-20">
        ...
        <div className="space-y-4">
          {sections.map((section) => (
            <div
              key={section.num}
              className={`brutal-box p-5 md:p-8 brutal-animate-up ${
                section.highlight
